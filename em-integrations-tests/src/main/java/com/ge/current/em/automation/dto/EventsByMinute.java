 ...
 * Created by 212582112 on 12/16/16.
 */
public class EventsByMinute implements Serializable {
    ...
    public String getEvent_bucket() {
        return event_bucket;
    }

    public void setEvent_bucket(String event_bucket) {
        this.event_bucket = event_bucket;
    }
