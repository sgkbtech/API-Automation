...
public class AggregationTest extends EMTestUtil{
	...
	private static final Long TS_FIVEMINS_OFFSET=(long)(5*60*1000);
...
//	String ahutags[] = { "zoneAirTempSensor", "dischargeAirTempSensor" };
	...
	public void testMetadataInFiveMinAggregationForFE2ESubmeter() throws URISyntaxException {
		setUp(getProperty("MinAggregation"), TS_FIVEMINS_OFFSET, getProperty("em.Submeter.Asset.assetSourcekey"));
		ASSET_TYPE = "SUBMETER";
		validate("MinAggregation",submetertags);
	}
	@Test
	public void testMetadataInFiveMinAggregationForFE2ESubmeterSite() throws URISyntaxException {
		setUp(getProperty("MinAggregation"), TS_FIVEMINS_OFFSET, getProperty("em.Submeter.Site.siteSourceKey"));
		ASSET_TYPE = "SUBMETER";
		validate("MinAggregation",submetertags);
	}
	@Test
	public void testMetadataInFiveMinAggregationForFE2ESubmeterEnterprise() throws URISyntaxException {
		setUp(getProperty("MinAggregation"), TS_FIVEMINS_OFFSET,
	...
	@Test
	public void testMetadataInFiveMinAggregationForFE2ESubmeterSegment() throws URISyntaxException {
		setUp(getProperty("MinAggregation"), TS_FIVEMINS_OFFSET, getProperty("em.Submeter.Segment.SourceKey"));
		ASSET_TYPE = "SUBMETER";
		validate("MinAggregation",submetertags);
	}
		...
		if (isElementFound) {
			...
			assertTrue(
					measures_aggr + tagValue
							...
							+ " \n actual : " + aggr,
					Double.valueOf(expectedMap.get(measures_aggr + tagValue).toString())
							.intValue() == aggr.intValue());
			if(!aggrOnly){
				avg = aggr / cnt;
				assertTrue(
	...
	@Test
	public void testMetadataInFiveMinAggregationForFE2EAHU() throws URISyntaxException {
		setUp(getProperty("MinAggregation"), TS_FIVEMINS_OFFSET, getProperty("em.Asset.assetSourcekey"));
		ASSET_TYPE = "AHU";
		validate("MinAggregation",ahutags);
	}

	@Test
	public void testMetadataInFiveMinAggregationForFE2EAHUSite() throws URISyntaxException {
		setUp(getProperty("MinAggregation"), TS_FIVEMINS_OFFSET, getProperty("em.Site.siteSourceKey"));
		ASSET_TYPE = "AHU";
		validate("MinAggregation",ahutags);
	}

	@Test
	public void testMetadataInFiveMinAggregationForFE2EAHUEnterprise() throws URISyntaxException {
		setUp(getProperty("MinAggregation"), TS_FIVEMINS_OFFSET,
	...
	@Test
	public void testMetadataInFiveMinAggregationForFE2EAHUSegment() throws URISyntaxException {
		setUp(getProperty("MinAggregation"), TS_FIVEMINS_OFFSET, getProperty("em.Segment.SegmentSourceKey"));
		ASSET_TYPE = "AHU";
		validate("MinAggregation",ahutags);
	}
